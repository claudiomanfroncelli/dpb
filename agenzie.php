            ...
            <form id="cercadati" method="post" action="#" data-toggle="validator">
                <div class="row">
                    ...
                    <div class="form-group btn-group col-md-7">
                        ...
                        <a href="agenzia_nuova.php" class="btn btn-danger btn-sm"
                           role="button" style="float:right">Inserisci una Agenzia</a>
                    </div>
                </div>
            </form>
