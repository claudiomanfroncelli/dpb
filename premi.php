...
<?php include_once "inc/inc.utils.php"; ?>
...
?>
    ...
    <!-- gestione delle caselle combinate compagnia e agenzia -->
        ...
        <div class="container">
            ...
            <form id="cercadati" method="post" action="#" data-toggle="validator">
                <div class="row">
                    ...
                    <div class="form-group col-md-3 has-feedback grassetto">
                    ...
                    <div class="form-group btn-group col-md-6">
                        ...
                        <a href="premio_nuovo.php" class="btn btn-danger btn-sm hidden"
                           role="button" style="float:right">Inserisci un Premio</a>
                    </div>
                </div>
            </form>
