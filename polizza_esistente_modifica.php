		...
		foreach ($rows as $row) {
            ...
            <div class="jumbotron">
                <div class="container">
                    ...
                    <form id="vedipolizza"
                          method="post"
                          action="polizza_esistente_aggiornamento.php"
									...
									<?php
										...
										if ($recordstipoappendice > 0) {
											...
											foreach ($rowstipoappendice as $rowtipoappendice) {
												...
												?>
                                                <option
                                                        value="<?php echo $id_tipoappendice ?>"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4 has-feedback">
                                ...
                                <select class="form-control input-sm" id="id_mandato_polizza"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-2 has-feedback">
                                ...
                                >
                                    <option value="..." <?php if ($capitolato_polizza == "...") {
										echo "selected";
									} ?> >...
                                    </option>
                                    <option value="si" <?php if ($capitolato_polizza == "si") {
										echo "selected";
									} ?> >Si
                                    </option>
                                    <option value="no" <?php if ($capitolato_polizza == "no") {
										echo "selected";
									} ?> >No
                                    </option>
                                </select>
