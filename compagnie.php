...
?>
    ...
    <div class="jumbotron">
        <div class="container">
            <h1>Elenco Compagnie</h1>

            <!-- due caselle a discesa per Compagnia e testo da cercare -->
                ...
                <div class="row">
                    <div class="form-group col-md-6 has-feedback grassetto ">
                        <select class="form-control input-sm-small col-md-6 has-feedback grassetto" id="compagnie"
                                name="compagnia">
							<?php
								echo $comp->ShowCompagnie(); ?>
                        </select>
                    </div>

					<?php
						$testodacercare = "";
						if (isset($_REQUEST['testodacercare']) && ($_REQUEST['testodacercare'] != "") && (preg_match("/^[-' a-z0-9]+$/i", $_REQUEST['testodacercare']))) {
                    ...
                    <div class="form-group btn-group col-md-12">
                        ...
                        <a href="compagnia_nuova.php" class="btn btn-danger btn-sm"
                           role="button" style="float:right">Inserisci una Nuova
                            Compagnia</a>
                    </div>
                </div>
            </form>
    ...
    <div id="risultato">
		...
		<?php include "compagnie_lista.php"; ?>
