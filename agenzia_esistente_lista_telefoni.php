...
<div class="table-responsive">
    <table class="table table-striped">
		...
		<?php
			...
			$conf_STR_sql = " SELECT * FROM telefoni_agenzia LEFT JOIN agenzie ON id_agenzia_telefono = id_agenzia WHERE 1=1 ";
			...
			while ($row = $q->fetch()) {
				...
				$num++;
				$telefono_agenzia = $row['numero_telefono_agenzia'];
				$tipo_telefono_agenzia = $row['tipo_telefono_agenzia'];

				?>

                <TR>

                    <td><?php echo "".$telefono_agenzia." "; ?></td>
                    <td><?php echo "".$tipo_telefono_agenzia." "; ?></td>
