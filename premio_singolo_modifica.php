...
//l'indirizzo direttamente sulla barra, e quindi va fermato
	if (isset($id_premio)) {
		...
		foreach ($rows as $row) {
            ...
            <!-- Righe di dettaglio -->
            <!-- inizio prima riga -->
            <div class="jumbotron" style="padding-right: 0; padding-left: 15px">
                <form id="vedipremio"
                      method="post"
                      action="premio_singolo_aggiornamento.php"
                      data-toggle="validator">
					<?php echo " <input type=\"hidden\" name=\"id_premio\" value={$id_premio}>"; ?>
					<?php echo " <input type=\"hidden\" name=\"id_polizza_premio\" value={$id_polizza_premio}>"; ?>
                    ...
                    <div class="row">
                        <div class="form-group btn-group col-md-offset-18 col-md-5" id="azioni">
